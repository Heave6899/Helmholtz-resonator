...
/////////////// Write the MCQ below in the exactly same described format ///////////////
  ...
  const myQuestions = [
    {
      question: "State the correct equation.",  ///// Write the question inside double quotes
      answers: {
        a: "ω=(k/m)^1/3",                  ///// Write the option 1 inside double quotes
        b: "ω=(k/m)^1/2",                  ///// Write the option 2 inside double quotes
